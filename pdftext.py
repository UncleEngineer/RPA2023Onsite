...
files = ['IV202308-01.pdf', 'IV202308-02.pdf', 'IV202308-03.pdf']
header = ['Date', 'Customer Name', 'Tel No.', 'Email', 'Total']
...
for f in files:
    ...
    # ค้นหา Date
    date_pattern = r"\d{1,2}\s[ADFJMNOS][a-z]+\s\d{4}"
